...
- **Advanced API**: Added `count()`, `merge()`, `upsert()`, `items_recursive()`, `find_all()`, `filter()`, and `update_many()` for complex data manipulation.
...
### Changed
- **Documentation**: Extensively rewrote `README.md` to include detailed feature descriptions, a technical tone, and updated installation instructions.
- **Web UI**: Clarified that the Web UI is a prototype demonstrating framework integration.
